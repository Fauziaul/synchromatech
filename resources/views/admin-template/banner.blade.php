...
<div class="row">
    ...
    <button class="btn btn-coklat waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#modal-background"  >
    Tambah
    </button>
    </div>
</div>
...
<div class="modal fade" id="modal-background" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form class="default-form" method="POST" enctype="multipart/form-data" action="{{ url('/admin/banner/store') }}">
                @csrf
...
<script>
    var table = $('#table-background').DataTable({
        ajax: '{{ url("admin/banner/show")}}',
        serverSide: false,
        processing: true,
        deferRender: true,
        type: 'GET',
